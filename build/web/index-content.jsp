        ...
        <c:if test="${param.action == 'modification'}" > 
            ...
            <fieldset>
                ...
                <form action="ServletUsers" method="post">
                    ...
                    <p>
                        <label for="codePostal">Code Postal : </label><input type="number" name="codePostal"/> <span style="color: #f00;">${requestScope['erreurs']['codePostal']}</span><br/><br/>
                    </p>
                    ...
                    <br/>
                    <p>
                        <label for="numero"></label><input type="number" name="numero"/> <span style="color: #f00;">${requestScope['erreurs']['numero']}</span><br/><br/>
                    </p>
                    <p>
                        <input type="hidden" name="contact" value="${param.contactID}"/>
                        <input type="hidden" name="contactNom" value="${param.contactNom}"/>
        ...
        <c:if test="${param.action == 'erreurajouterUneAdresse'}" > 
            ...
            <fieldset>
                ...
                <form action="ServletUsers" method="post">
                    ...
                    <p>
                        <label for="nom">Code Postal : </label><input type="number" name="codePostal" required/><span style="color: #f00;">${requestScope['erreurs']['codePostal']}</span><br/>
                    </p>
        ...
        <c:if test="${param.action == 'ajouterUneAdresse'}" > 
            ...
            <fieldset>
                ...
                <form action="ServletUsers" method="post">
                    ...
                    <p>
                        <label for="nom">Code Postal : </label><input type="number" name="codePostal" required/>
                    </p>
        ...
        <c:if test="${param.action == 'supprimerUnNumero'}" > 
            ...
            <fieldset>
                ...
                <form action="ServletUsers" method="post">
                    ...
                    <button type="submit" value="Supprimer le numéro" class="red small fa fa-phone-square">Supprimer le numéro</button>
                    </p>
                </form>  
            </fieldset>
        </c:if>
        ...
        <c:if test="${param.action == 'supprimerUneAdresse'}" > 
            ...
            <fieldset>
                ...
                <form action="ServletUsers" method="post">
                    ...
                    <button type="submit" class="red small fa fa-book" value="SupprimerAdresse">Supprimer l'adresse</button>
                        ...
                        <tr>  
                            ...
                            <c:if test="${empty u.pictureName}">
                                <td>
                                    <form action="ServletUsers" method="get">
                                        ...
                                        <!-- <input type="submit" value="Envoyer" class="sansLabel" /> -->
                                        <button type="submit" value="Envoyer" class="green medium fa fa-picture-o"> +</button>
                                    </form>
                                </td>
                            </c:if>
                            <c:if test="${!empty u.pictureName}">
                            ...
                            <td>
                                ...
                                <form action="ServletUsers" method="get">
                                    ...
                                    <button type="submit" value="Ajouter" class=" green small fa fa-phone-square"> +</button>
                                </form>
                                <%--</c:if>--%>
                            </td>
                            <td>
                                ...
                                <form action="ServletUsers" method="get">
                                    ...
                                    <!-- <input type="submit" value="Ajouter" name="submit"/> -->
                                    <button type="submit" value="Ajouter" class="green small fa fa-book"> +</button>
                                </form>
                                <%--</c:if>--%>
                            </td>
                            <td>
